  ...
  return (
    <section ref={ref} className="relative py-24 sm:py-32 px-6 sm:px-8 bg-white">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/2 left-0 w-[500px] h-[500px] bg-[#DE6E27]/3 rounded-full blur-3xl -translate-y-1/2" />
        <div className="absolute top-1/2 right-0 w-[500px] h-[500px] bg-[#DE6E27]/5 rounded-full blur-3xl translate-y-1/2" />
      </div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="relative p-10 sm:p-12 md:p-16 bg-gradient-to-br from-[#2B3210] to-[#1a1d0a] text-white overflow-hidden rounded-3xl shadow-xl"
          >
            {/* Ambient glow */}
          ...
          <motion.div
            ...
            className="relative p-10 sm:p-12 md:p-16 bg-gradient-to-br from-white to-[#FBF8EF]/50 overflow-hidden rounded-3xl shadow-xl border border-gray-100"
          >
            {/* Ambient glow */}
        ...
        {/* Tagline */}
        <motion.p
          className="text-center mt-12 sm:mt-16 text-lg sm:text-xl md:text-2xl text-gray-600 font-light max-w-3xl mx-auto"
